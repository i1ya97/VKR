...
import { fetchArticles, selectOpenSideBar, selectUser, setArticles, setOpenSideBar } from '@features/common';
...
import { Forecasting } from '@widgets/Forecasting';
      ...
      <RootComponent>
        ...
        <Box sx={{ width: openSideBar.value ? 'calc(100% - 320px)' : 'calc(100% - 88px)', height: '100%' }}>
          <Routes>
            ...
            <Route path="/data-analysis" element={<ResidueControl />} />
